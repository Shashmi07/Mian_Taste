...
import hoteggspicy from '../../assets/hoteggspicy.jpg';
import cheeseramenchicken from '../../assets/cheeseChicken.jpg';
  ...
  const [menuItems] = useState([
    {
      id: '1',
      name: 'Beef Soup',
      description: 'Savory beef broth with tender meat, noodles, and fresh herbs',
      price: 1500,
      category: 'ramen',
      image: beefsoup,
      available: true,
    ...
    },
    {
      id: '2',
      name: 'Hot Egg Spicy',
      description: 'Fiery chili broth with soft-boiled egg and fresh noodles',
      price: 1250,
      category: 'ramen',
      image: hoteggspicy,
      available: true,
    ...
    {
      id: '5',
      name: 'Cheese Ramen Chicken',
      description: 'Creamy cheese ramen with tender chicken and rich broth',
      price: 1500,
      category: 'ramen',
      image: cheeseramenchicken,
      available: true,
      rating: 4.8
    },
  ]);
          ...
          {filteredItems.map(item => (
            <div key={item.id} className="border border-green-100 rounded-lg overflow-hidden hover:shadow-md transition-shadow bg-white">
              ...
              <div className="p-4">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-xl font-bold text-green-600">RS {item.price}</span>
