...
import seafoodRamen from '../../assets/SeafoodRamen.jpg'; // Fixed: SeafoodRamen.jpg (capital S)
...
const menuItems = [
  ...
  { name: "Seafood Ramen", price: "RS.1400", image: seafoodRamen, description: "Fresh seafood in savory ramen broth" },
  ...
  { name: "Buldak Beef Ramen", price: "RS.1500", image: beefPorkBuldak, description: "Spicy Buldak pork and beef ramen" },
